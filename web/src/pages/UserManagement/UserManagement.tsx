            ...
            {users?.map(u => (
              <tr key={u.uid}>
                ...
                <td className="table-actions">
                  <button onClick={() => { setEditingUser(u); setModalOpen(true); }}>Edit</button>
                  <button className="btn-danger" onClick={() => confirm("Delete user?") && deleteMutation.mutate({ email: u.email })}>Delete</button>
                </td>
              </tr>
            ))}
          </tbody>
        ...
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <form onSubmit={handleSave}>
              ...
              <input name="roles" defaultValue={editingUser?.roles.join(", ")} placeholder="admin, user" />

              <label>Permissions (comma separated)</label>
              <input name="perms" defaultValue={editingUser?.perms.join(", ")} placeholder="users:manage, admin:access" />

              <div className="modal-footer">
                <button type="button" onClick={closeModal}>Cancel</button>
                <button type="submit" className="btn-primary" disabled={upsertMutation.isPending || createMutation.isPending}>
